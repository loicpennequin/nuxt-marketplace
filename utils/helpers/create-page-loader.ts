...
export type TrpcQuery<T extends TrpcQueryPath> = ReturnType<
  typeof useTrpcQuery<T, any>
>;

type LoaderDependencies<T extends TrpcKeyDictionary> = {
  [Property in keyof T]?: TrpcQuery<T[Property]>['data']['value'];
};
...
type UseTrpcQueryRecord<T extends TrpcKeyDictionary> = {
  [Property in keyof T]: TrpcQuery<T[Property]>;
};
